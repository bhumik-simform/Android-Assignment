package com.example.assignmentchapter3androide.ui.fragments.home
...
import com.example.assignmentchapter3androide.viewModel.HomeViewModel
    ...
    private fun setupSearchMenu() {
        ...
        searchView.setOnQueryTextListener( object : SearchView.OnQueryTextListener{
            ...
            override fun onQueryTextChange(p0: String?): Boolean {
                viewModel.updateSearchQuery(p0.orEmpty())
                return false
            }
